...
(1,'h1@naver.com','h1','1111'),
(2,'h2@naver.com','h2','2222'),
(3,'h3@naver.com','h3','3333'),
(4,'zzz@naver.com','zame','1234');
...
(1,'hong','hong@naver.com','1234','user'),
(2,'kim','kim@naver.com','2222','seller'),
(3,'lee','lee@naver.com','3333','seller'),
(4,'park','parkg@naver.com','4444','user');
...
CREATE TABLE `product` (
  ...
  `product_save` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `member_id` (`member_id`),
  CONSTRAINT `product_ibfk_1` FOREIGN KEY (`member_id`) REFERENCES `member` (`id`)
...
-- Dump completed on 2025-05-30 15:37:05
